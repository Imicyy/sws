...
<body>
  ...
  <div class="layout">
    <aside class="sidebar">
      ...
      <a class="nav-link active" href="<?= htmlspecialchars(app_url('/barangay-senior-dashboard'), ENT_QUOTES, 'UTF-8') ?>">
    ...
    <main class="main">
      <div class="top-header" style="display:flex;justify-content:center;align-items:flex-start;position:relative;">
        ...
        <div style="position:absolute;right:0;top:0;display:flex;align-items:center;gap:20px;">
          <div style="position:relative;">
            <button id="notifBellBrgySenior" style="background:transparent;border:0;cursor:pointer;padding:8px;border-radius:8px;font-size:20px;">🔔 <span id="notifBadgeBrgySenior" style="background:#dc2626;color:#fff;border-radius:10px;padding:2px 6px;font-size:12px;display:none;margin-left:6px;">0</span></button>
      ...
      <div class="stats" style="grid-template-columns: repeat(4, minmax(0, 1fr));">
        ...
        <div class="stat-card">
          ...
          <div class="stat-content">
            <div class="stat-top-label">Total Senior Citizen Count</div>

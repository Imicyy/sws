...
<body>
  <div class="page-shell">
    <div class="topbar">
      <div>
        <h1 id="formTitle">Person With Disability FORM</h1>
    ...
    <form id="housingForm" action="/register-pwd" method="post">
      <div class="progress-bar">
        ...
        <div class="step"><span>Types / Cause Disability</span></div>
      </div>
  ...
  <script type="text/javascript" src="/files/assets/js/pwd.js"></script>
  <script type="text/javascript" src="/files/assets/js/validation.js"></script>
</body>
</html>
